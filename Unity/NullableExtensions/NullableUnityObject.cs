...
var rb = go.GetComponent<Rigidbody>().Nullable() ?? throw new MyCustomException();

var rb = go.GetComponent<Rigidbody>().ThrowIfNull("NRE: null ref exception");  // shorthand for `?? throw`
```
...
#pragma warning restore CS0618
        ...
        where T : Object
    {
        ...
        [Obsolete("use `Nullable()` extension method for unity object instead to create instance")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
